...
(function (g, p, q, r) {
    function n(a) {
        return "string" === typeof a ? a.replace(/[\u53f0]+/gi, "\u81fa") : a
    }
    ...
    m.prototype = {
        ...
        get: function (a) {
            function b(a) {
                "undefined" !== typeof c.wrap[a] && e.push(c.wrap[a].val())
            }
            var c = this,
                e = [];
            "function" === typeof a ? a.call(this, this.wrap.county.val(), this.wrap.district.val(), this.wrap.zipcode.val()) : "string" === typeof a ? a.split(",").forEach(b) : Array.isArray(a) ?
                a.forEach(b) : e = this.wrap;
            return e
        },
        set: function (a) {
            var b = g.extend({}, {
        ...
        reset: function (a,
            ...
            switch (b) {
                ...
                default:
                    ...
                    c.district.html('<option value="">\u9109\u93ae\u5e02\u5340</option>');
                    for (d in f) "undefined" !== typeof f[d] && -1 === e.hideCounty.indexOf(d) && l.push('<option value="' + d + '">' + d + "</option>");
        ...
        bindings: function () {
            ...
            c.county.on("change.twzipcode", function () {
                ...
                if (k) {
                    if (!0 === b.zipcodeIntoDistrict)
                        for (h in f[k]) "undefined" !== typeof f[k][h] && -1 === b.hideDistrict.indexOf(h) && -1 === b.hideDistrict.indexOf(f[k][h]) && (d.push('<option value="' + h + '">'), d.push(f[k][h] + " " + h), d.push("</option>"));
                    else
                        for (h in f[k]) "undefined" !== typeof f[k][h] && -1 === b.hideDistrict.indexOf(h) && -1 === b.hideDistrict.indexOf(f[k][h]) && (d.push('<option value="' + h + '">'), d.push(h), d.push("</option>"));
                    c.district.append(d.join("")).trigger("change.twzipcode")
                ...
                if (3 === a.length)
                    for (d in f)
                        if ("undefined" !== typeof f[d])
                            for (e in f[d])
                                if ("undefined" !== typeof f[d][e] && a === f[d][e]) {
                                    c.county.val(d).trigger("change.twzipcode");
                                    c.district.val(e).trigger("change.twzipcode");
                                    break
                                }
            ...
            (function () {
                var b = a.role.zipcode.data(),
                    ...
                    d = a.role.district.data(),
                    e;
                for (e in b) "role" !== e && a.role.zipcode.find(":input").attr(e, b[e]);
                for (e in c) "role" !== e && a.role.county.find("select").attr(e,
                    c[e]);
                for (e in d) "role" !== e && a.role.district.find("select").attr(e, d[e])
            })();
            e = "undefined" !== typeof b.zipcodeSel ? b.zipcodeSel : "undefined" !== typeof a.role.zipcode.data("value") ? a.role.zipcode.data("value") : b.zipcodeSel;
            d = "undefined" !== typeof b.countySel ? b.countySel : "undefined" !== typeof a.role.county.data("value") ? a.role.county.data("value") : b.countySel;
            ...
            d &&
                (d = n(d), a.wrap.county.val(d).trigger("change.twzipcode"), "undefined" !== typeof f[d] && "undefined" !== typeof f[d][l] && a.wrap.district.val(l).trigger("change.twzipcode"));
            e && 3 === e.toString().length && a.wrap.zipcode.val(e).trigger("blur.twzipcode")
        },
        geoLocation: function (a) {
            ...
            c && a && c.getCurrentPosition(function (c) {
                var d = {};
                "coords" in c && "latitude" in c.coords && "longitude" in c.coords && (d = [c.coords.latitude, c.coords.longitude], g.getJSON("https://maps.googleapis.com/maps/api/geocode/json", {
                    key: e.googleMapsKey,
                    sensor: !1,
                    latlng: d.join(",")
                }, function (d) {
        ...
        init: function () {
            var a =
                ...
                e = c.county.data("name") || b.countyName,
                d = c.district.data("name") || b.districtName,
                f = c.zipcode.data("name") || b.zipcodeName,
                k = c.zipcode.data("placeholder") || b.zipcodePlaceholder,
                h = c.zipcode.data("readonly") || b.readonly;
            g("<select/>").attr("name", e).addClass(c.county.data("style") || ("undefined" !== typeof b.css[0] ? b.css[0] : "")).appendTo(c.county.length ?
                c.county : a);
            g("<select/>").attr("name", d).addClass(c.district.data("style") || ("undefined" !== typeof b.css[1] ? b.css[1] : "")).appendTo(c.district.length ? c.district : a);
            g("<input/>").attr({
                type: "text",
                name: f,
                placeholder: k
            ...
            this.wrap = {
                county: a.find('select[name="' + e + '"]:first'),
                district: a.find('select[name="' + d + '"]:first'),
    ...
    g.fn.twzipcode = function (a) {
        ...
        return "string" === typeof a ? (this.each(function () {
            ...
            b instanceof m && "function" === typeof b[a] && (c = b[a].apply(b, Array.prototype.slice.call(e, 1)))
